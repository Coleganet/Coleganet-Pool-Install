...
output() {
 printf "\E[0;33;40m" echo $1 printf "\E[0m" }
}
...
' | sudo -E tee /etc/nginx/sites-available/$server_name.conf >/dev/null 2>&1
    ...
    output "Installing  supervisor system files and restart nginx"

    cp $HOME/Coleganet-Pool-Install/supervisor/conf.d/* /etc/supervisor/conf.d
